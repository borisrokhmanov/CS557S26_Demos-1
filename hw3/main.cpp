...
int main(int argc, char *argv[])
{
    ...
    {	
    timerLaplacian.Reset(); timerSaxpy.Reset(); timerCopy.Reset(); timerNorm.Reset(); timerInner.Reset();
    ConjugateGradients(matrix, L, x, f, p, r, z, false); //writeIterations disabled
    ...
    timerInner.Print("Total Inner Product Time : ");
    }
